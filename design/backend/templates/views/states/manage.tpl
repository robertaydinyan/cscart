        ...
        <div class="table-responsive-wrapper longtap-selection">
            ...
            >
                ...
                <td width="10%" class="right" data-th="{__("status")}">
                    ...
                    {include file="common/select_popup.tpl" type="states" id=$state.state_id status=$state.status hidden="" object_id_name="state_id" table="states" non_editable=!$has_permission_update_status}
                </td>
            </tr>
            {/foreach}
            </table>
