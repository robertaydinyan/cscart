                        ...
                        <tr id="upgrade_{$id}">
                            <td>
                                <div class="upgrade-center_icon">
                                    {include file="views/upgrade_center/components/package_icon.tpl"
                                        package=$package
                                    }
                                </div>
                            </td>
...
{capture name="adv_buttons"}
    {hook name="upgrade_center:adv_buttons"}
        {include file="common/popupbox.tpl"
            id="upload_upgrade_package_container"
            text=__("upload_upgrade_package")
            title=__("upload_upgrade_package")
            link_text=__("upload_upgrade_package")
            content=$smarty.capture.upload_upgrade_package
            act="general"
