        ...
        <div class="table-responsive-wrapper longtap-selection" id="taxes_content">
            ...
            >
                ...
                <td width="10%" class="right nowrap" data-th="{__("status")}">
                    ...
                    {include file="common/select_popup.tpl" type="taxes" id=$tax.tax_id status=$tax.status object_id_name="tax_id" table="taxes" non_editable=!$has_permission}
                </td>
            </tr>
            {/foreach}
            </table>
