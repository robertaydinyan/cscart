                    ...
                    >
                        ...
                        <td class="row-status" data-th="{__("name")}">
                            {if $has_management_permissions}
                                <a class="row-status cm-external-click link--monochrome" data-ca-external-click-id="{"opener_plan_`$plan.plan_id`"}">
                            {/if}
                                {$plan.plan}
                            {if $has_management_permissions}
                                </a>
...
{capture name="adv_buttons"}
    {if $has_management_permissions}
        {include file="common/popupbox.tpl"
            ...
            text=__("vendor_plans.new_vendor_plan")
            title=__("vendor_plans.add_vendor_plan")
            link_text=__("vendor_plans.add_vendor_plan")
